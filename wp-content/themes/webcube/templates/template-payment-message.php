...
/**
 * Template Name: Payment Message Template
 * Description: A custom page template for payment message pages
 */
...
// Function to replace TX-ID placeholder with actual transaction ID
function replace_tx_id($content)
{
    $tx_id = isset($_GET['tx']) ? esc_html($_GET['tx']) : '';
    return str_replace('%%TX-ID%%', $tx_id, $content);
}
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class('content'); ?>>
                ...
                <?php if ($main_description) : ?>
                    <div class="main-description mb-4">
                        <?php echo wp_kses_post(replace_tx_id($main_description)); ?>
                    </div>
                <?php endif; ?>
                        ...
                        <div class="col-lg-8 mb-4 mb-lg-0 order-1 <?php echo $is_even ? 'order-lg-1' : 'order-lg-2'; ?> px-0">
                            <div class="feature-card content d-flex flex-column justify-content-center p-0 h-100 <?php echo $is_even ? 'mx-3 me-lg-5' : 'mx-3 ms-lg-5'; ?>">
                                ...
                                <div class="feature-description">
                                    <?php echo wp_kses_post(replace_tx_id($section['description'])); ?>
                                </div>
